...
if (luckyNum === 1){
    alert("Congrats! You get a 10% discount!")
        ...
        alert("Congrats! Everything you chose today is free!!")
    }
}
 ...
 */
let numAsk = confirm("Would you like to enter a number?");
if (numAsk === true){
